...
Pod::Spec.new do |s|
  s.name             = 'LinkDetect'
  s.version          = '0.1.0'
  s.summary          = 'A short description of LinkDetect.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/<GITHUB_USERNAME>/LinkDetect'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Nahit Rüştü HEPER' => 'nahitheper@gmail.com' }
  s.source           = { :git => 'https://github.com/<GITHUB_USERNAME>/LinkDetect.git', :tag => s.version.to_s }
